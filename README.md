...
See `.kimi-code/skills/pve-debian-template-mirror/` for diagnosing HTTP/1.1 keep-alive issues with domestic mirrors behind OpenClash and for updating an existing PVE template disk offline.
